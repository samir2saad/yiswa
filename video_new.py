...
def main(media_url: str , caption: str ,conversationId:str ,media_type:str="video") -> dict:
    """
    Sends a media message (e.g., video) with a caption to a conversation.
    
    Args:
        media_url (str): URL of the media to send.
        media_type (str): Type of media (e.g., "video").
